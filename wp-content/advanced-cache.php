...
$possible_plugin_locations = array(
	...
	'C:\Bitnami\wordpress-5.7.2-0\apps\wordpress\htdocs\wp-content\plugins\wp-optimize\cache',
);
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\Bitnami\wordpress-5.7.2-0\apps\wordpress\htdocs\wp-content\plugins\wp-optimize\cache/extensions');
}
